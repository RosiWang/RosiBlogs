<template>
    <div id="contact">
        ...
        <div class="info animated tada">
            ...
            <div class="wraper">
                <p class="left">邮箱:</p><p class="right">rosiwang.mark@gmail.com</p>
                <p class="left">QQ:</p><p class="right">272914287</p>
                <p class="left">公司:</p><p class="right">Insta360</p>
            </div>
        </div>
    </div>
</template>
...
#contact {
    min-height: 30rem;
    padding: 0 1rem 5rem;
    background: rgba(205, 202, 213, 0.79);
    .title {
        p.headline {
            width: 13rem;
        }
